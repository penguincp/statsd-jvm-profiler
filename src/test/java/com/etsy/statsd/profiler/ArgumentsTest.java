...
public class ArgumentsTest {
	...
	public void testConfFileArgument() {
		...
		assertArrayEquals(new String[] { "bean1", "bean2", "bean3" },
				arguments.getStringListArguments("tomcat.sessionBeans"));
		assertArrayEquals(new String[] { "attr3", "attr4" },
				arguments.getStringListArguments("tomcat.sessionAttributes"));
	}
